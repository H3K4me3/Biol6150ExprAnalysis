...
We use a cutoff of adjusted p value by 0.05.

```{r}
resOrdered <- res[order(res$padj),]
resOrdered <- as.data.frame(resOrdered)[resOrdered$padj < 0.05, ]
...
```{r}
knitr::kable(resOrdered[,c("symbol", "baseMean", "log2FoldChange", "pvalue", "padj")][1:100,])
```
